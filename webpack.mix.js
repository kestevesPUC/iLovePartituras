...
mix.webpackConfig({
    plugins: [
        new WebpackShellPluginNext({
            onBuildStart:{
                scripts: ['php artisan lang:js public/assets/js/common/Lang.js --quiet', 'php artisan ziggy:generate public/js/common/Routes.js --quiet'],
                blocking: true,
                parallel: false
            }, onBuildEnd: [] })
    ],
 ...
 */
mix.scripts([
    'resources/assets/plugins/flatpickr/pt.js',
    'resources/assets/plugins/flatpickr/monthSelect.js',
    'resources/assets/plugins/flatpickr/confirmDate.js',
], 'public/assets/plugins/flatpickr.js');
...
mix.scripts([
    ...
    'resources/js/common/DataTable-Paginate.js',
    'resources/js/common/DataTable.js',
    'resources/assets/plugins/datatables/dataTables.fixedHeader.min.js',
], 'public/assets/js/EssentialTables.js').version();

/**
 * UTIL
 */
mix.babel([
    'public/assets/js/common/Lang.js',
...
mix.scripts([
    ...
    'resources/js/order/makeOrder.js',
    'resources/js/order/nfse.js',
], 'public/js/order/order.js').version();

mix.scripts([
    'resources/js/user/user.js',
], 'public/js/user/user.js').version();

//Charts

mix.scripts([
    'resources/js/charts/charts.js'
], 'public/js/charts/charts.js').version();
mix.scripts([
    'resources/js/charts/index.js',
    'resources/js/charts/echarts/bar.js',
    'resources/js/charts/echarts/map.js',
    'resources/js/charts/echarts/pie.js',
    'resources/js/charts/echarts/bar-race.js',
    'resources/js/charts/echarts/bar-race2.js',
    'resources/js/charts/echarts/table.js',
],'public/js/charts/echarts.js').version();
