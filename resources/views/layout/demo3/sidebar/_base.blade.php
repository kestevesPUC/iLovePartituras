            ...
            >
                ...
                <div class="tab-content px-5 px-xxl-10">
                    ...
                    <div class="tab-pane fade" id="kt_sidebar_tab_1" role="tabpanel">
                        {{ theme()->getView('layout/demo3/sidebar/widgets/_stats', array('category' => 'tasks')) }}

                        {{ theme()->getView('layout/demo3/sidebar/widgets/_tasks') }}
                    </div>
                    <!--end::Tab pane-->

                    <!--begin::Tab pane-->
                    <div class="tab-pane fade" id="kt_sidebar_tab_2" role="tabpanel">
                        {{ theme()->getView('layout/demo3/sidebar/widgets/_stats', array('category' => 'orders')) }}

                        {{ theme()->getView('layout/demo3/sidebar/widgets/_orders') }}
                    </div>
                    <!--end::Tab pane-->

                    <!--begin::Tab pane-->
                    <div class="tab-pane fade show active" id="kt_sidebar_tab_3" role="tabpanel">
                        {{ theme()->getView('layout/demo3/sidebar/widgets/_stats', array('category' => 'tickets')) }}

                        {{ theme()->getView('layout/demo3/sidebar/widgets/_best-sellers') }}
                    </div>
                    <!--end::Tab pane-->

                    <!--begin::Tab pane-->
                    <div class="tab-pane fade" id="kt_sidebar_tab_4" role="tabpanel">
                        {{ theme()->getView('layout/demo3/sidebar/widgets/_stats', array('category' => 'notifcations')) }}
                    ...
                    <div class="tab-pane fade" id="kt_sidebar_tab_5" role="tabpanel">
                        {{ theme()->getView('layout/demo3/sidebar/widgets/_stats', array('category' => 'mail')) }}
