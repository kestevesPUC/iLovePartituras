<x-auth-layout>
    ...
    <!--begin::Heading-->
        ...
        <div class="fv-row mb-8 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
            <!--begin::Email-->
            <label>Email</label>
            <input type="text" placeholder="Digite o email" name="email" autocomplete="off" class="form-control bg-transparent" required autofocus>
            <!--end::Email-->
        </div>
        <!--end::Input group=-->
        ...
        <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
            ...
            <!--begin::Link-->
                <a href="{{ theme()->getPageUrl('password.request') }}" id="resetPassword" class="link-primary">Esqueceu a senha?</a>
                <!--end::Link-->
            @endif
        </div>
        <!--end::Wrapper-->
        ...
        <!--end::Submit button-->
        <!--begin::Sign up-->
        <div class="text-gray-500 text-center fw-semibold fs-6">Não é um usuario?
            <a href="{{ theme()->getPageUrl('register') }}" id="singUp" class="link-primary">Registre-se</a>
        </div>
        <!--end::Sign up-->
        <div></div>
    </form>
