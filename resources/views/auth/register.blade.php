<x-auth-layout>
    ...
    <!--begin::Heading-->
        <div class="text-center mb-11">
            <!--begin::Title-->
            <h1 class="text-dark fw-bolder mb-3">Registre-se</h1>
            <!--end::Title-->
            <!--begin::Subtitle-->
            <div class="text-gray-500 fw-semibold fs-6">Com midia social</div>
            <!--end::Subtitle=-->
        </div>
        <!--begin::Heading-->
        <!--begin::Login options-->
        ...
        <div class="separator separator-content my-14">
            <span class="w-125px text-gray-500 fw-semibold fs-7">Com Email</span>
        </div>
        <!--end::Separator-->
        ...
        <div class="row fv-row mb-8">
            <!--begin::Col-->
            <label>Nome:</label>
            <input class="form-control form-control-lg form-control-solid" type="text" name="first_name" autocomplete="off" value="{{ old('first_name') }}" placeholder="Por favor digite seu nome"/>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
        ...
        <div class="fv-row mb-8 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
            <!--begin::Email-->
            <label>Email:</label>
            <input type="text" placeholder="Por favor digite o email" name="email" autocomplete="off" class="form-control bg-transparent">
            <!--end::Email-->
        </div>
        <!--begin::Input group-->
        ...
        <div class="fv-row mb-8 fv-plugins-icon-container" data-kt-password-meter="true">
            ...
            <div class="mb-1">
                ...
                <div class="position-relative mb-3">
                    <label>Senha:</label>
                    <input class="form-control bg-transparent" type="password" placeholder="Por favor digite uma senha" name="password" autocomplete="off">
            ...
            <!--end::Wrapper-->
            <!--begin::Hint-->
            <div class="text-muted">Utilize 8 ou mais caracteres com mistura de letras, numeros &amp; simbolos.</div>
            <!--end::Hint-->
        </div>
        <!--end::Input group=-->
        <!--end::Input group=-->
        <div class="fv-row mb-8 fv-plugins-icon-container">
            ...
            <input placeholder="Por favor repita a senha" name="password_confirmation" type="password" autocomplete="off" class="form-control bg-transparent">
            <!--end::Repeat Password-->
        </div>
        <!--end::Input group=-->
        <!--begin::Accept-->
        <div class="fv-row mb-8 fv-plugins-icon-container">
            <label class="form-check form-check-inline">
                ...
                <span class="form-check-label fw-semibold text-gray-700 fs-base ms-1">Eu aceito os
                    <a href="#" class="ms-1 link-primary">Temos</a></span>
            </label>
        </div>
        <!--end::Accept-->
        <!--begin::Submit button-->
        ...
        <!--end::Submit button-->
        <!--begin::Sign up-->
        <div class="text-gray-500 text-center fw-semibold fs-6">Você já possui uma conta?
